      ...
      <div className="knowledge-page noto-sans-sc ">
        ...
        <div className="wave-container">
          <div className="wave-item hover-effect">
            ...
            <img
              src={`${process.env.PUBLIC_URL}/images/wave/p_wave.gif`}
              alt="P波"
            />
          </div>
          ...
          <div className="wave-item hover-effect">
            ...
            <img
              src={`${process.env.PUBLIC_URL}/images/wave/s_wave.gif`}
              alt="s波"
            />
          </div>
          ...
          <div className="wave-item hover-effect">
            ...
            <img
              src={`${process.env.PUBLIC_URL}/images/wave/rayleigh_wave.gif`}
              alt="Rayleigh波"
            />
          </div>
          ...
          <div className="wave-item hover-effect">
            ...
            <img
              src={`${process.env.PUBLIC_URL}/images/wave/love_wave.gif`}
              alt="Love波"
            />
          </div>
        </div>
